...
describe('GET /rest/:id', () => {
    test.concurrent.each(ids)('Schiff zu vorhandener ID %i', async (id) => {
        // given
    ...
    test.concurrent('Kein Schiff zu nicht-vorhandener ID', async () => {
        // given
    ...
    test.concurrent('Kein Schiff zu falscher ID', async () => {
        // given
    ...
    test.concurrent.each(idsETag)(
        'Schiff zu ID %i mit If-None-Match',
        async (id) => {
            // given
            const url = `${restURL}/${id}`;
